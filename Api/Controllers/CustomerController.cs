...
namespace Api.Controllers
{
    ...
    public class CustomerController : BaseController
    {
        ...
        public async Task<IActionResult> CreateCustomer(AddCustomerDto addCustomerDto)
        {
            ...
            return result == null ? BadRequest() : CreatedAtAction(nameof(GetCustomer), new { id = result.Id }, result); // Return 400 Bad Request if order is null, otherwise return 201 Created.
        }
        ...
        public async Task<IActionResult> GetCustomer(int id)
        {
            ...
            return customerDto == null ? NotFound() : Ok(customerDto); // Return 404 Not Found if order is not found, otherwise return 200 OK.
        }
        ...
        {
            return await _customerService.UpdateCustomer(id, updateCustomerDto) == null ? NotFound() : NoContent(); // Return 404 Not Found if order is not found, otherwise return 204 No Content.
        }
